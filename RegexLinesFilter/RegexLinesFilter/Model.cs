...
namespace RegexLinesFilter
{
  public class Model
  {
    ...
    private IEnumerable<string> LoadFileLines(string file, Encoding encoding)
    {
    ...
    {
      SetRawLines(LoadFileLines(file, encoding));
    }

    public void SetRawLines(IEnumerable<string> lines)
    {
      myContent.Clear();
      myContent.AddRange(lines);
      DocumentUpdated(this, new DocumentUpdatedEventArgs());
    }
